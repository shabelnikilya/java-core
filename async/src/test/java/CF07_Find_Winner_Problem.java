...
public class CF07_Find_Winner_Problem extends CompletableFutureBase {

    /*
     * Кто победитель забега? (должен занять 2 секудны и вернуть 2)
     */
    @Test
    public void testFind_Winner() throws Exception {
        ...
        CompletableFuture<?> winner
                = CompletableFuture.anyOf(future1, future2);  // здесь ваше решение
